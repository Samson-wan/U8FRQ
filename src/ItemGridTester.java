...
public class ItemGridTester
{
    public static void main(String[] args)
    {
        ...
        // create test itemGrid object, ig
        ItemGrid ig = new ItemGrid(gridOfItems);

        // TEST PART A
        System.out.println("\n---- TESTING PART A ----");

        // if any of the 12 valid test cases are FALSE, test fails!
        boolean twelveValid = ig.isValid(0, 0) && ig.isValid(0, 1) && ig.isValid(0, 2) && ig.isValid(0, 3) &&
                ig.isValid(1, 0) && ig.isValid(1, 1) && ig.isValid(1, 2) && ig.isValid(1, 3) &&
                ig.isValid(2, 0) && ig.isValid(2, 1) && ig.isValid(2, 2) && ig.isValid(2, 3);

        // if any of the invalid test cases are TRUE, test fails!
        boolean fourInvalid = ig.isValid(0, 4) || ig.isValid(3, 1) || ig.isValid(-1, 2) || ig.isValid(1, -1);

        // twelveValid should be true, fourInvalid should be false
        if (twelveValid && !fourInvalid)
        {
        ...
        else
        {
            ...
            System.out.println("*** twelveValid should be true and is: " + twelveValid);
            System.out.println("*** fourInvalid should be false and is: " + fourInvalid);
        }
        ...
        {
            System.out.println("Tesing Part C PASSED!");
        }
        else
        {
            System.out.println("*** Tesing Part CB FAILED! ***");
